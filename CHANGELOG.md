...
- Copyright headers
- Add AzureDataStudio update script
- [ #1932](https://github.com/PowerShell/vscode-PowerShell/1932) -
  Add scripts for automatically updating the version of the PowerShell extension 
- [ #1945](https://github.com/PowerShell/vscode-PowerShell/1945) -
  Edit snippets to support $TM_SELECTED_TEXT  (Thanks @travis-c-lagrone!)
- [ #1942](https://github.com/PowerShell/vscode-PowerShell/1942) -
  stop supporting 6.0 
- [ #1928](https://github.com/PowerShell/vscode-PowerShell/1928) -
  Add RunCode command for CodeLens providers 
- [ #1927](https://github.com/PowerShell/vscode-PowerShell/1927) -
  fix change session by moving to async/await promise 
- [ #1931](https://github.com/PowerShell/vscode-PowerShell/1931) -
  Fix upload bug report 
- [ #1925](https://github.com/PowerShell/vscode-PowerShell/1925) -
  Fix error in HtmlContentView.ShowContent when no JS/CSS provided  (Thanks @rkeithhill!)
- [ #1919](https://github.com/PowerShell/vscode-PowerShell/1919) -
  Fix CustomViews by switching to WebViews 
- [ #1922](https://github.com/PowerShell/vscode-PowerShell/1922) -
  Fix small typo in Function-Inline description  (Thanks @V-ed!)
- [ #1908](https://github.com/PowerShell/vscode-PowerShell/1908) -
  Add powershell version telemetry 
- [ #1900](https://github.com/PowerShell/vscode-PowerShell/1900) -
  Small update to Azure Data Studio MP README  (Thanks @SQLvariant!)
- [ #1871](https://github.com/PowerShell/vscode-PowerShell/1871) -
  Azure pipelines 
- [ #1867](https://github.com/PowerShell/vscode-PowerShell/1867) -
  Change Whitespace settings to camelCase 
- [ #1852](https://github.com/PowerShell/vscode-PowerShell/1852) -
...
- [ #1839](https://github.com/PowerShell/vscode-PowerShell/1839) -
  add initial credscan ymls 
- [ #1837](https://github.com/PowerShell/vscode-PowerShell/1837) -
  Not -EncodedCommand on Windows 
- [ #1825](https://github.com/PowerShell/vscode-PowerShell/1825) -
  Switch to current lowercase names for powershell and mdlint exts  (Thanks @rkeithhill!)
- [ #1823](https://github.com/PowerShell/vscode-PowerShell/1823) -
...
- [ #952](https://github.com/PowerShell/PowerShellEditorServices/952) -
  Update to PSReadLine 2.0.0-beta4 
- [ #877](https://github.com/PowerShell/PowerShellEditorServices/877) -
  (GH-879) Add filtering for CodeLens and References  (Thanks @glennsarti!)
- 🐛 [vscode-powershell #1933](https://github.com/PowerShell/PowerShellEditorServices/949) -
  Stop crash when workspace doesn't exist 
- [ #878](https://github.com/PowerShell/PowerShellEditorServices/878) -
  Remove native named pipes implementation 
- [ #947](https://github.com/PowerShell/PowerShellEditorServices/947) -
  Fix silent failure by using Id for dictionary since multiple pages could have the same title 
- [ #946](https://github.com/PowerShell/PowerShellEditorServices/946) -
  rename to use async 
- [ #943](https://github.com/PowerShell/PowerShellEditorServices/943) -
...
- [ #921](https://github.com/PowerShell/PowerShellEditorServices/921) -
  Set up CI with Azure Pipelines 
- [ #908](https://github.com/PowerShell/PowerShellEditorServices/908) -
  Fix issue with reference code lens not working with UNC paths  (Thanks @rkeithhill!)
- 🐛 [vscode-powershell #1571](https://github.com/PowerShell/PowerShellEditorServices/911) -
  Fix faulty netfx check 
- [ #906](https://github.com/PowerShell/PowerShellEditorServices/906) -
  Fix New-EditorFile with no folder or no files open 
- ✨ [vscode-powershell #1398](https://github.com/PowerShell/PowerShellEditorServices/902) -
  Improve path auto-completion  (Thanks @rkeithhill!)
- [ #910](https://github.com/PowerShell/PowerShellEditorServices/910) -
  Fix UseCorrectCasing to be actually configurable via"powershell.codeFormatting.useCorrectCasing"  (Thanks @bergmeister!)
- [ #909](https://github.com/PowerShell/PowerShellEditorServices/909) -
  Use global.json to pin .Net Core SDK version and update it from 2.1.402 to 2.1.602  (Thanks @bergmeister!)
- [ #903](https://github.com/PowerShell/PowerShellEditorServices/903) -
...
- [ #904](https://github.com/PowerShell/PowerShellEditorServices/904) -
  add initial credscan ymls 
- [ #901](https://github.com/PowerShell/PowerShellEditorServices/901) -
  Switch to current lowercase names for powershell and mdlint exts  (Thanks @rkeithhill!)
