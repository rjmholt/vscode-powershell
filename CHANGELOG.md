...
- Copyright headers
- Add AzureDataStudio update script
- [vscode-PowerShell #1959](https://github.com/PowerShell/vscode-PowerShell/1959) -
  add rich nav 
...
- Start changes
- [PowerShellEditorServices #944](https://github.com/PowerShell/PowerShellEditorServices/944) -
